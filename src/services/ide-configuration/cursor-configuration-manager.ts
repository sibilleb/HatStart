 ...
 * Handles Cursor-specific IDE configuration operations
 */
...
/**
 * Cursor-specific configuration manager
 */
export class CursorConfigurationManager extends BaseIDEConfigurationManager {
  public readonly ideType: IDEType = 'cursor';

  /**
   * Get the command name for Cursor CLI
   */
  ...
  /**
   * Convert settings to Cursor-specific format
   */
