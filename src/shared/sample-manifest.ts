...
import type { CategoryManifest, MasterManifest, ToolManifest } from './manifest-types';

// Sample tool manifests
export const sampleNodeJS: ToolManifest = {
  id: 'nodejs',
  name: 'Node.js',
...
export const sampleVSCode: ToolManifest = {
  id: 'vscode',
...
export const sampleFrontendCategory: CategoryManifest = {
  category: 'frontend',
...
export const sampleMasterManifest: MasterManifest = {
  metadata: {
  ...
  categoryManifests: {
    'frontend': sampleFrontendCategory,
    'backend': sampleFrontendCategory, // Placeholder
    'devops': sampleFrontendCategory, // Placeholder
    'mobile': sampleFrontendCategory, // Placeholder
    'design': sampleFrontendCategory, // Placeholder
    'testing': sampleFrontendCategory, // Placeholder
    'database': sampleFrontendCategory, // Placeholder
    'productivity': sampleFrontendCategory, // Placeholder
    'security': sampleFrontendCategory, // Placeholder
    'language': sampleFrontendCategory, // Placeholder
    'version-control': sampleFrontendCategory, // Placeholder
    'cloud': sampleFrontendCategory // Placeholder
  },
  defaults: {
    experienceLevel: 'intermediate',
    platform: 'macos',
